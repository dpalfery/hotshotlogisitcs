      ...
      {shipmentData && (
        <View style={styles.shipmentInfo}>
          ...
          <View style={styles.mapPlaceholder}>
            ...
            <Text style={styles.locationText}>{shipmentData.currentLocation}</Text>
            <Text style={styles.mapSubtext}>[Map integration would show driver location]</Text>
          </View>

          <View style={styles.infoCard}>
            <Text style={styles.infoText}>ETA: {shipmentData.eta}</Text>
            <Text style={styles.infoText}>Driver: {shipmentData.driverName}</Text>
          </View>
